...
func runResilientNexthopScenario(enableIPv4, enableIPv6 bool) {
	...
	cleanup := func() {
		...
		_ = runIP("nexthop", "del", "id", fmt.Sprintf("%d", constants.NexthopGroupIDIPv4))
		_ = runIP("nexthop", "del", "id", fmt.Sprintf("%d", constants.NexthopGroupIDIPv6))
		_ = runIP("nexthop", "del", "id", fmt.Sprintf("%d", constants.NexthopDeviceBaseIPv4+0))
		_ = runIP("nexthop", "del", "id", fmt.Sprintf("%d", constants.NexthopDeviceBaseIPv4+1))
		_ = runIP("nexthop", "del", "id", fmt.Sprintf("%d", constants.NexthopDeviceBaseIPv6+0))
		_ = runIP("nexthop", "del", "id", fmt.Sprintf("%d", constants.NexthopDeviceBaseIPv6+1))
